...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Msrconstants / Edit #{{$msrconstant->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('msrconstants.update', $msrconstant->id) }}" method="POST">
                ...
                <div style="max-width: 250px;" class="form-group @if($errors->has('documentno')) has-error @endif">
                    ...
                    <input type="text" id="documentno-field" name="documentno" class="form-control" value="{{ is_null(old("documentno")) ? $msrconstant->documentno : old("documentno") }}"/>
                    ...
                    <input type="text" id="revisionno-field" name="revisionno" class="form-control" value="{{ is_null(old("revisionno")) ? $msrconstant->revisionno : old("revisionno") }}"/>
                    ...
                    <input type="text" id="revisiondate-field" name="revisiondate" class="form-control" value="{{ is_null(old("revisiondate")) ? $msrconstant->revisiondate : old("revisiondate") }}"/>
