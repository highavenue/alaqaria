        ...
        <div class="col-md-12">
            @if($types->count())
                <table class="table table-condensed table-striped">
                    ...
                    <td>{{$type->name_ar}}</td>
                                <td class="text-right">
                                    <a class="btn btn-xs btn-primary" href="{{ route('types.show', $type->id) }}"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                                    <a class="btn btn-xs btn-warning" href="{{ route('types.edit', $type->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
