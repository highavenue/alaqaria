...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Vendorregistrations / Edit #{{$vendorregistration->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('vendorregistrations.update', $vendorregistration->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('registryno')) has-error @endif">
                    ...
                    <input type="text" id="registryno-field" name="registryno" class="form-control" value="{{ is_null(old("registryno")) ? $vendorregistration->registryno : old("registryno") }}"/>
                    ...
                    <input type="text" id="companyregisteredname-field" name="companyregisteredname" class="form-control" value="{{ is_null(old("companyregisteredname")) ? $vendorregistration->companyregisteredname : old("companyregisteredname") }}"/>
                    ...
                    <input type="text" id="companyparentname-field" name="companyparentname" class="form-control" value="{{ is_null(old("companyparentname")) ? $vendorregistration->companyparentname : old("companyparentname") }}"/>
                    ...
                    <input type="text" id="establishment-field" name="establishment" class="form-control" value="{{ is_null(old("establishment")) ? $vendorregistration->establishment : old("establishment") }}"/>
                    ...
                    <input type="text" id="classification-field" name="classification" class="form-control" value="{{ is_null(old("classification")) ? $vendorregistration->classification : old("classification") }}"/>
                    ...
                    <input type="text" id="bldname-field" name="bldname" class="form-control" value="{{ is_null(old("bldname")) ? $vendorregistration->bldname : old("bldname") }}"/>
                    ...
                    <input type="text" id="bldno-field" name="bldno" class="form-control" value="{{ is_null(old("bldno")) ? $vendorregistration->bldno : old("bldno") }}"/>
                       @if($errors->has("bldno"))
                    ...
                    <input type="text" id="floorno-field" name="floorno" class="form-control" value="{{ is_null(old("floorno")) ? $vendorregistration->floorno : old("floorno") }}"/>
                    ...
                    <input type="text" id="streetname-field" name="streetname" class="form-control" value="{{ is_null(old("streetname")) ? $vendorregistration->streetname : old("streetname") }}"/>
                    ...
                    <input type="text" id="streetno-field" name="streetno" class="form-control" value="{{ is_null(old("streetno")) ? $vendorregistration->streetno : old("streetno") }}"/>
                    ...
                    <input type="text" id="zoneno-field" name="zoneno" class="form-control" value="{{ is_null(old("zoneno")) ? $vendorregistration->zoneno : old("zoneno") }}"/>
                    ...
                    <input type="text" id="city-field" name="city" class="form-control" value="{{ is_null(old("city")) ? $vendorregistration->city : old("city") }}"/>
                       @if($errors->has("city"))
                    ...
                    <input type="text" id="country-field" name="country" class="form-control" value="{{ is_null(old("country")) ? $vendorregistration->country : old("country") }}"/>
                    ...
                    <input type="text" id="postalcode-field" name="postalcode" class="form-control" value="{{ is_null(old("postalcode")) ? $vendorregistration->postalcode : old("postalcode") }}"/>
                    ...
                    <input type="text" id="boxno-field" name="boxno" class="form-control" value="{{ is_null(old("boxno")) ? $vendorregistration->boxno : old("boxno") }}"/>
                       @if($errors->has("boxno"))
                    ...
                    <input type="text" id="telephoneno-field" name="telephoneno" class="form-control" value="{{ is_null(old("telephoneno")) ? $vendorregistration->telephoneno : old("telephoneno") }}"/>
                    ...
                    <input type="text" id="email-field" name="email" class="form-control" value="{{ is_null(old("email")) ? $vendorregistration->email : old("email") }}"/>
                       @if($errors->has("email"))
                    ...
                    <input type="text" id="faxno-field" name="faxno" class="form-control" value="{{ is_null(old("faxno")) ? $vendorregistration->faxno : old("faxno") }}"/>
                       @if($errors->has("faxno"))
                    ...
                    <input type="text" id="natureofbusiness-field" name="natureofbusiness" class="form-control" value="{{ is_null(old("natureofbusiness")) ? $vendorregistration->natureofbusiness : old("natureofbusiness") }}"/>
                    ...
                    <input type="text" id="fieldoftrade-field" name="fieldoftrade" class="form-control" value="{{ is_null(old("fieldoftrade")) ? $vendorregistration->fieldoftrade : old("fieldoftrade") }}"/>
                    ...
                    <input type="text" id="fieldoftradetext-field" name="fieldoftradetext" class="form-control" value="{{ is_null(old("fieldoftradetext")) ? $vendorregistration->fieldoftradetext : old("fieldoftradetext") }}"/>
                    ...
                    <input type="text" id="personname-field" name="personname" class="form-control" value="{{ is_null(old("personname")) ? $vendorregistration->personname : old("personname") }}"/>
                    ...
                    <input type="text" id="personjobtitle-field" name="personjobtitle" class="form-control" value="{{ is_null(old("personjobtitle")) ? $vendorregistration->personjobtitle : old("personjobtitle") }}"/>
                    ...
                    <input type="text" id="personemail-field" name="personemail" class="form-control" value="{{ is_null(old("personemail")) ? $vendorregistration->personemail : old("personemail") }}"/>
                    ...
                    <input type="text" id="personmobileno-field" name="personmobileno" class="form-control" value="{{ is_null(old("personmobileno")) ? $vendorregistration->personmobileno : old("personmobileno") }}"/>
                    ...
                    <input type="text" id="persontelephoneno-field" name="persontelephoneno" class="form-control" value="{{ is_null(old("persontelephoneno")) ? $vendorregistration->persontelephoneno : old("persontelephoneno") }}"/>
                    ...
                    <input type="text" id="personfaxno-field" name="personfaxno" class="form-control" value="{{ is_null(old("personfaxno")) ? $vendorregistration->personfaxno : old("personfaxno") }}"/>
                    ...
                    <textarea class="form-control" id="submitteddocuments-field" rows="3" name="submitteddocuments">{{ is_null(old("submitteddocuments")) ? $vendorregistration->submitteddocuments : old("submitteddocuments") }}</textarea>
                    ...
                    <input type="text" id="noofyears-field" name="noofyears" class="form-control" value="{{ is_null(old("noofyears")) ? $vendorregistration->noofyears : old("noofyears") }}"/>
                    ...
                    <input type="text" id="client1-field" name="client1" class="form-control" value="{{ is_null(old("client1")) ? $vendorregistration->client1 : old("client1") }}"/>
                    ...
                    <input type="text" id="location1-field" name="location1" class="form-control" value="{{ is_null(old("location1")) ? $vendorregistration->location1 : old("location1") }}"/>
                    ...
                    <input type="text" id="duration1-field" name="duration1" class="form-control" value="{{ is_null(old("duration1")) ? $vendorregistration->duration1 : old("duration1") }}"/>
                    ...
                    <input type="text" id="client2-field" name="client2" class="form-control" value="{{ is_null(old("client2")) ? $vendorregistration->client2 : old("client2") }}"/>
                    ...
                    <input type="text" id="location2-field" name="location2" class="form-control" value="{{ is_null(old("location2")) ? $vendorregistration->location2 : old("location2") }}"/>
                    ...
                    <input type="text" id="duration2-field" name="duration2" class="form-control" value="{{ is_null(old("duration2")) ? $vendorregistration->duration2 : old("duration2") }}"/>
                    ...
                    <input type="text" id="client3-field" name="client3" class="form-control" value="{{ is_null(old("client3")) ? $vendorregistration->client3 : old("client3") }}"/>
                    ...
                    <input type="text" id="location3-field" name="location3" class="form-control" value="{{ is_null(old("location3")) ? $vendorregistration->location3 : old("location3") }}"/>
                    ...
                    <input type="text" id="duration3-field" name="duration3" class="form-control" value="{{ is_null(old("duration3")) ? $vendorregistration->duration3 : old("duration3") }}"/>
                    ...
                    <input type="text" id="pleasespecify-field" name="pleasespecify" class="form-control" value="{{ is_null(old("pleasespecify")) ? $vendorregistration->pleasespecify : old("pleasespecify") }}"/>
                    ...
                    <input type="text" id="previousbusinessname-field" name="previousbusinessname" class="form-control" value="{{ is_null(old("previousbusinessname")) ? $vendorregistration->previousbusinessname : old("previousbusinessname") }}"/>
                    ...
                    <input type="text" id="reasonforchange-field" name="reasonforchange" class="form-control" value="{{ is_null(old("reasonforchange")) ? $vendorregistration->reasonforchange : old("reasonforchange") }}"/>
                    ...
                    <input type="text" id="certifications-field" name="certifications" class="form-control" value="{{ is_null(old("certifications")) ? $vendorregistration->certifications : old("certifications") }}"/>
                    ...
                    <input type="text" id="certificationbody1-field" name="certificationbody1" class="form-control" value="{{ is_null(old("certificationbody1")) ? $vendorregistration->certificationbody1 : old("certificationbody1") }}"/>
                    ...
                    <input type="text" id="validity1-field" name="validity1" class="form-control" value="{{ is_null(old("validity1")) ? $vendorregistration->validity1 : old("validity1") }}"/>
                    ...
                    <input type="text" id="certificationbody2-field" name="certificationbody2" class="form-control" value="{{ is_null(old("certificationbody2")) ? $vendorregistration->certificationbody2 : old("certificationbody2") }}"/>
                    ...
                    <input type="text" id="validity2-field" name="validity2" class="form-control" value="{{ is_null(old("validity2")) ? $vendorregistration->validity2 : old("validity2") }}"/>
                    ...
                    <input type="text" id="bankname-field" name="bankname" class="form-control" value="{{ is_null(old("bankname")) ? $vendorregistration->bankname : old("bankname") }}"/>
                    ...
                    <input type="text" id="accountname-field" name="accountname" class="form-control" value="{{ is_null(old("accountname")) ? $vendorregistration->accountname : old("accountname") }}"/>
                    ...
                    <input type="text" id="accountno-field" name="accountno" class="form-control" value="{{ is_null(old("accountno")) ? $vendorregistration->accountno : old("accountno") }}"/>
                    ...
                    <input type="text" id="swiftcode-field" name="swiftcode" class="form-control" value="{{ is_null(old("swiftcode")) ? $vendorregistration->swiftcode : old("swiftcode") }}"/>
                    ...
                    <input type="text" id="currency-field" name="currency" class="form-control" value="{{ is_null(old("currency")) ? $vendorregistration->currency : old("currency") }}"/>
                    ...
                    <input type="text" id="ibanno-field" name="ibanno" class="form-control" value="{{ is_null(old("ibanno")) ? $vendorregistration->ibanno : old("ibanno") }}"/>
                    ...
                    <input type="text" id="bankbldgname-field" name="bankbldgname" class="form-control" value="{{ is_null(old("bankbldgname")) ? $vendorregistration->bankbldgname : old("bankbldgname") }}"/>
                    ...
                    <input type="text" id="bankbldgno-field" name="bankbldgno" class="form-control" value="{{ is_null(old("bankbldgno")) ? $vendorregistration->bankbldgno : old("bankbldgno") }}"/>
                    ...
                    <input type="text" id="bankfloorno-field" name="bankfloorno" class="form-control" value="{{ is_null(old("bankfloorno")) ? $vendorregistration->bankfloorno : old("bankfloorno") }}"/>
                    ...
                    <input type="text" id="bankstreetname-field" name="bankstreetname" class="form-control" value="{{ is_null(old("bankstreetname")) ? $vendorregistration->bankstreetname : old("bankstreetname") }}"/>
                    ...
                    <input type="text" id="bankstreetno-field" name="bankstreetno" class="form-control" value="{{ is_null(old("bankstreetno")) ? $vendorregistration->bankstreetno : old("bankstreetno") }}"/>
                    ...
                    <input type="text" id="bankzoneno-field" name="bankzoneno" class="form-control" value="{{ is_null(old("bankzoneno")) ? $vendorregistration->bankzoneno : old("bankzoneno") }}"/>
                    ...
                    <input type="text" id="bankcity-field" name="bankcity" class="form-control" value="{{ is_null(old("bankcity")) ? $vendorregistration->bankcity : old("bankcity") }}"/>
                    ...
                    <input type="text" id="bankcountry-field" name="bankcountry" class="form-control" value="{{ is_null(old("bankcountry")) ? $vendorregistration->bankcountry : old("bankcountry") }}"/>
                    ...
                    <input type="text" id="bankpostalcode-field" name="bankpostalcode" class="form-control" value="{{ is_null(old("bankpostalcode")) ? $vendorregistration->bankpostalcode : old("bankpostalcode") }}"/>
                    ...
                    <input type="text" id="bankpoboxno-field" name="bankpoboxno" class="form-control" value="{{ is_null(old("bankpoboxno")) ? $vendorregistration->bankpoboxno : old("bankpoboxno") }}"/>
                    ...
                    <input type="text" id="banktelephoneno1-field" name="banktelephoneno1" class="form-control" value="{{ is_null(old("banktelephoneno1")) ? $vendorregistration->banktelephoneno1 : old("banktelephoneno1") }}"/>
                    ...
                    <input type="text" id="financecontactperson-field" name="financecontactperson" class="form-control" value="{{ is_null(old("financecontactperson")) ? $vendorregistration->financecontactperson : old("financecontactperson") }}"/>
                    ...
                    <input type="text" id="banktelephoneno2-field" name="banktelephoneno2" class="form-control" value="{{ is_null(old("banktelephoneno2")) ? $vendorregistration->banktelephoneno2 : old("banktelephoneno2") }}"/>
                    ...
                    <input type="text" id="bankemailaddress-field" name="bankemailaddress" class="form-control" value="{{ is_null(old("bankemailaddress")) ? $vendorregistration->bankemailaddress : old("bankemailaddress") }}"/>
                    ...
                    <input type="text" id="bankfaxno-field" name="bankfaxno" class="form-control" value="{{ is_null(old("bankfaxno")) ? $vendorregistration->bankfaxno : old("bankfaxno") }}"/>
                    ...
                    <input type="text" id="locationofoffice-field" name="locationofoffice" class="form-control" value="{{ is_null(old("locationofoffice")) ? $vendorregistration->locationofoffice : old("locationofoffice") }}"/>
                    ...
                    <input type="text" id="commregno-field" name="commregno" class="form-control" value="{{ is_null(old("commregno")) ? $vendorregistration->commregno : old("commregno") }}"/>
                    ...
                    <input type="text" id="qcmembership-field" name="qcmembership" class="form-control" value="{{ is_null(old("qcmembership")) ? $vendorregistration->qcmembership : old("qcmembership") }}"/>
                    ...
                    <input type="text" id="taxcardno-field" name="taxcardno" class="form-control" value="{{ is_null(old("taxcardno")) ? $vendorregistration->taxcardno : old("taxcardno") }}"/>
                    ...
                    <input type="text" id="otherdetails-field" name="otherdetails" class="form-control" value="{{ is_null(old("otherdetails")) ? $vendorregistration->otherdetails : old("otherdetails") }}"/>
