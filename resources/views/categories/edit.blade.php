        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('categories.update', $category->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name_en')) has-error @endif">
                    ...
                    <input type="text" id="name_en-field" name="name_en" class="form-control" value="{{ is_null(old("name_en")) ? $category->name_en : old("name_en") }}"/>
                    ...
                    <input type="text" id="name_ar-field" name="name_ar" class="form-control" value="{{ is_null(old("name_ar")) ? $category->name_ar : old("name_ar") }}"/>
